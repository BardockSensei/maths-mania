...
function preload() {
  player.img = loadImage("assets/player.jpg");
}
...
function setup() {
  ...
  pauseButton.size(width / 12, 60);
  pauseButton.position(width / 24, height + height / 3);
...
function showReplayButton() {
  ...
  replayButton.position(width / 2 - 50, height / 2 + 120); // Centré sous le message "Game Over"
